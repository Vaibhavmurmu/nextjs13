...
export default function Navbar() {
    return (
        ...
        <div className=" mt-12 items-center max-w-md mx-auto sm:w-full justify-around sm:w-full fixed flex-row bg-natural-50 backdrop-blur-sm shadow-sm opecity-25 blur-none h-8 px-20 py-12 hidden sm:flex">
