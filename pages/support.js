...
export default function PageWithJSbasedSupport() {
  ...
  return (
      ...
      <p className="mt-2 text-1xl bottom-2">We support your business</p>
      <form onSubmit={handleSubmit}>
        ...
        <span className="mt-2 w-96 rounded-xl p-6">Full name</span>
        ...
        <label className="mt-2 w-96 rounded-xl p-6" htmlFor="password">Address</label>
        <input className="mt-1 block w-80 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" id="address" name="address" required />

        <button className="mt-4 item-center bg-orange-600 text-white w-80 hover:bg-blue-600 hover:text-white font-n py-3 border rounded-md" type="sign up">Request</button>
      </form> 
      <p className="mt-1 text-0xl text-blue-600 bottom-2">
        We reach you immediately
      </p>
     </div>
    </main>
  )
