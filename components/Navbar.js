...
export default function Navbar() {
    return (
        ...
        <div className=" mt-6 flex-col items-center justify-around sm:w-full fixed flex-row bg-natural-50 backdrop-blur-sm shadow-sm opecity-25 blur-none h-8 px-20 py-16 hidden sm:flex">
