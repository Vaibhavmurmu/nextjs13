...
export default function Navbar() {
    return (
        <main className="mt-6 flex w-full flex-1 flex-col items-center justify-centre px-20 text-center">
        <div className=" mt-0 items-center max-w-lg mx-auto w-full justify-around md:w-full fixed flex-row bg-natural-50 backdrop-blur-sm shadow-sm opecity-25 blur-none h-4 px-20 py-12 hidden md:flex">
